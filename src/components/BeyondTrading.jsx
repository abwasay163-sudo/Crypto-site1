...
export const BeyondTrading = () => {
  return (
    <section 
      className="relative py-20 pb-32 overflow-hidden"
      style={{
    ...
    >
      <div className="max-w-[1248px] mx-auto px-6 relative z-10">
        <h2 className="text-3xl md:text-[40px] font-bold font-outfit text-white tracking-tight mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {bCards.map((card, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative flex flex-col justify-between h-[420px] lg:h-[480px] w-full cursor-pointer overflow-hidden rounded-[24px] lg:rounded-[32px] border border-white/5 bg-[#10141e]"
            >
              <img
                src={card.image}
                alt={card.title}
              ...
              <div className="relative z-20 p-8 h-full flex flex-col justify-between">
                <h3 className="text-3xl font-bold font-outfit text-white tracking-wide">
                  {card.title}
                </h3>
                
                <div className="flex items-end justify-between gap-4 mt-auto">
                  <p className="text-[#a1a7c0] text-[16px] lg:text-[18px] leading-relaxed max-w-[85%] font-medium">
                    {card.description}
                  </p>
                  
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/20 bg-black/40 backdrop-blur-md transition-all duration-300 group-hover:bg-white/20 group-hover:border-white/40">
