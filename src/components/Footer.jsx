    ...
    <footer className="bg-black text-white py-24 border-t border-white/5">
      <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-primary/50 flex-grow"
              />
              <button 
                type="submit"
                className="bg-primary text-white p-2 rounded-lg hover:bg-primary/80 transition-all font-medium text-sm px-4"
              >
                Join
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-white/20 text-xs">
          <p>© {years} Wasay's Crypto. All rights reserved.</p>
