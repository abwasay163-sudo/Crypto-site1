  ...
  return (
    <div className="flex items-center gap-4 group cursor-pointer transition-all duration-300 hover:opacity-100 opacity-80">
      <div className="flex items-center">
        ...
        {/* Right Branch SVG */}
        <svg width="24" height="42" viewBox="0 0 24 42" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white/60 group-hover:text-white transition-colors">
          <path d="M2 6C6 6 9 9 10 12C12 9 16 7 19 7M10 12C12 16 13 21 13 26C13 32 10 38 7 42M10 12C10 12 14 15 17 18M13 26C13 26 17 28 19 32M11 36C11 36 16 38 18 41" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      </div>
...
export const Features = () => {
  return (
    <section className="w-full py-24 pb-32" style={{ background: "#080D1B" }}>
      <div className="max-w-[1240px] mx-auto px-6">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="flex flex-col items-center text-center gap-10 mb-20 md:mb-24"
        >
          <h2 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-white leading-tight font-outfit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
          {featuresData.map((feature, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col justify-between h-[360px] p-8 lg:p-10 rounded-[20px] transition-all duration-300 hover:scale-[1.02]"
              style={{
            ...
            >
              <div className="flex flex-col gap-6">
                ...
                <h3 className="text-[28px] lg:text-[32px] font-bold text-white font-outfit leading-[1.1] whitespace-pre-line">
                  {feature.title}
                </h3>
              </div>
              
              <div>
                <p className="text-[#8e95a5] text-[15px] leading-relaxed font-outfit font-medium whitespace-pre-line">
                  {feature.desc}
                </p>
              </div>
            </motion.div>
