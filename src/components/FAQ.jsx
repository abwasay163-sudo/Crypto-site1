...
export const FAQ = () => {
  ...
  return (
    <section className="w-full py-12 md:py-16 lg:py-24" style={{ background: "#080D1B" }}>
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        <h2 className="text-xl md:text-2xl font-bold text-white font-outfit mb-8 md:mb-10 px-2 lg:px-0">
          FAQ
        </h2>
        ...
        <div className="w-full flex-grow flex flex-col">
            ...
            return (
              ...
              >
                <button 
                  ...
                  className="w-full flex items-center justify-between py-4 sm:py-6 text-left focus:outline-none group px-2 lg:px-0"
                >
                  <span className="text-[16px] sm:text-[18px] md:text-[20px] font-bold text-white font-outfit transition-colors leading-snug pr-4">
                    {faq.question}
                  </span>
                  <div className="text-gray-400 shrink-0">
                    {isOpen ? (
                      <svg width="20" height="20" className="sm:w-[24px] sm:h-[24px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="pb-6 sm:pb-8 pt-2 px-2 lg:px-0 text-[#c9cfdd] font-normal text-[14px] sm:text-[15px] leading-relaxed font-outfit pr-4 lg:pr-12">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
          ...
          <div className="pt-8 px-2 lg:px-0 text-white font-outfit font-bold text-[15px] sm:text-[17px] md:text-lg">
        ...
        <div className="w-full mt-16 sm:mt-24 pt-8 sm:pt-12 border-t border-white/5 flex flex-col gap-12 sm:gap-16">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-10">
            {/* Left text */}
            <div className="text-[#8e95a5] text-[12px] sm:text-[13px] leading-relaxed max-w-[800px] flex flex-col gap-4 sm:gap-5 font-sans px-2 lg:px-0">
              <p>
            ...
            {/* Right Logos */}
            <div className="flex flex-wrap items-center gap-4 lg:gap-6 opacity-80 px-2 lg:px-0">
              <img src="/14.svg" alt="AICPA SOC" className="h-8 sm:h-10 lg:h-12 w-auto object-contain" />
              <img src="/15.svg" alt="SGS" className="h-8 sm:h-10 lg:h-12 w-auto object-contain" />
              <img src="/16.svg" alt="SGS" className="h-8 sm:h-10 lg:h-12 w-auto object-contain" />
              <img src="/17.svg" alt="PCI DSS" className="h-8 sm:h-10 lg:h-12 w-auto object-contain" />
            </div>
          </div>

          {/* Bottom Row: Logo & Language */}
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mt-2 sm:mt-4 px-2 lg:px-0">
            {/* Logo area */}
            <div className="flex items-center gap-3">
              <svg width="24" height="24" className="sm:w-[28px] sm:h-[28px]" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-xl sm:text-2xl font-bold tracking-tight text-white mb-0.5 font-sans">crypto.com</span>
            </div>

            {/* Language / Region */}
            <div className="flex items-center gap-2 text-white/80 font-bold text-xs sm:text-sm font-sans tracking-wide">
